-- Migration: Simplify Golf App Schema
-- Date: 2025-06-01
...
-- Step 3: Drop old rounds table and recreate simplified version
DROP TABLE IF EXISTS rounds CASCADE;

-- Create simplified rounds table
CREATE TABLE rounds (
...
-- Step 4: Create new bag_setups table (enhanced bags table)
...
-- Step 5: Create enhanced notes table (rename and enhance user_notes)
...
-- Step 6: Add foreign key constraint for bag_setup_id in rounds
ALTER TABLE rounds 
ADD CONSTRAINT fk_rounds_bag_setup 
FOREIGN KEY (bag_setup_id) REFERENCES bag_setups(id);
